...
ms.locfileid: "138053051"
---
<a name="semaphorejs"></a>semaphore.js
============

[![Статус сборки](https://travis-ci.org/abrkn/semaphore.js.svg?branch=master)](https://travis-ci.org/abrkn/semaphore.js)

Установка: npm install semaphore

Ограничение одновременного доступа к ресурсу.
