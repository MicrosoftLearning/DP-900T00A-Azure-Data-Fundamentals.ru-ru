...
ms.locfileid: "138052415"
---
# <a name="nodejs-abi"></a>Node.js ABI

[![Статус сборки](https://travis-ci.org/lgeiger/node-abi.svg?branch=v1.0.0)](https://travis-ci.org/lgeiger/node-abi) [![Значок Greenkeeper](https://badges.greenkeeper.io/lgeiger/node-abi.svg)](https://greenkeeper.io/)


Предоставляет ABI Node.js для заданного целевого объекта и среды выполнения и наоборот.
