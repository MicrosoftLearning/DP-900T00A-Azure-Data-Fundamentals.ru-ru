# Сопоставление заданий для преподавателя DP-900

Этот курс DP-900: Основы данных Microsoft Azure включает набор лабораторных занятий, предназначенных для обучения под руководством инструктора. 

> Примечание. Преподаватели могут попросить учащихся выполнить одно или несколько лабораторных работ в свободное время, используя упражнения в соответствующих путях обучения «Обучение».(https://docs.microsoft.com/users/23110622/collections/0kjyh8rn5gdrjj). 
