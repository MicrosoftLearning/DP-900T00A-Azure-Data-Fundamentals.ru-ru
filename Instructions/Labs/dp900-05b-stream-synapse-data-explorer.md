...
> **Примечание**. Из-за изменений продукта существуют некоторые известные проблемы с **разделом Создание базы данных и прием данных** этого задания. Мы работаем над решением этих проблем.
...
1. В левой части Synapse Studio используйте **&rsaquo;&rsaquo;** значок , чтобы развернуть меню. Здесь отображаются различные страницы в Synapse Studio, которые будут использоваться для управления ресурсами и выполнения задач аналитики данных.
