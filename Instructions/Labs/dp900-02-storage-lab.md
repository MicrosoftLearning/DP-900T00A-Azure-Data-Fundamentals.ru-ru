...
1. **На странице "Контейнеры"** выберите **&#65291; Контейнер** и добавление нового контейнера `data` с анонимным уровнем доступа частного (без анонимного **доступа).**
...
1. Выберите **&65291; Добавьте каталог** и прочитайте сведения о папках перед созданием нового каталога с именем `products`.
...
1. На панели **Загрузка BLOB-объектов** выберите файл **product1.json**, сохраненный на локальном компьютере ранее. Затем в разделе "Дополнительно" в **поле "Отправить в папку **" введите **`product_data` и нажмите кнопку **"Отправить**".**
...
2. Нажмите кнопку **"Далее": >** резервного копирования и отключите резервное копирование. Щелкните **Просмотр и создание**.
