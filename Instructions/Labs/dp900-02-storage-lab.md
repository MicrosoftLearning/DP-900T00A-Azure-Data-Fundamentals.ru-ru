...
1. **На странице "Контейнеры"** выберите **&#65291; Контейнер** и добавление новых именованных **данных** контейнера с анонимным уровнем доступа частного (без анонимного **доступа).**
