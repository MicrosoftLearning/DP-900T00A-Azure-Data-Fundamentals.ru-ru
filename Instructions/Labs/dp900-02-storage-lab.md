...
# Изучение службы хранилища Azure
...
1. Перейдите к остальным страницам **Далее >** , не изменяя параметры по умолчанию, а затем на странице  **Проверка** дождитесь проверки выбранных вариантов и нажмите кнопку **Создать** , чтобы создать учетную запись хранения Azure.
